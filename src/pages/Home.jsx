                ...
                {selectedService && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-4xl bg-gradient-to-br from-zinc-900 to-black border border-white/20 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl my-4 sm:my-8"
                        >
