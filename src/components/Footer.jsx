            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
                    ...
                    <div className="md:col-span-4 space-y-8">
                        <h2 className="text-3xl font-bold font-heading tracking-tight uppercase">
                        ...
                        <div className="flex gap-4">
                            {[Instagram, Linkedin, Twitter].map((Icon, i) => (
                                <a key={i} href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-all hover:-translate-y-1">
                                    <Icon size={20} />
                                </a>
                            ))}
                        </div>
                            ...
                            {['Home', 'About', 'Services', 'Founders', 'Contact'].map((item) => (
                                <li key={item}>
                                    <Link
                                        ...
                                        className="text-gray-400 hover:text-white hover:pl-2 transition-all inline-flex items-center gap-2 group"
                                    >
                                        {item}
                    ...
                    <div className="md:col-span-5">
                        ...
                        <div className="grid gap-6">
                            <a href="tel:+919623761343" className="flex items-start gap-4 p-4 rounded-xl hover:bg-white/5 transition-colors group">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold font-mono">+91 96237 61343</p>
                                </div>
                            </a>

                            <a href="https://wa.me/919665961721" className="flex items-start gap-4 p-4 rounded-xl hover:bg-white/5 transition-colors group">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold font-mono">+91 96659 61721</p>
                                </div>
                            </a>
                ...
                {/* Animated Divider */}
                <div className="w-full h-[1px] bg-white/10 overflow-hidden relative mb-8">
